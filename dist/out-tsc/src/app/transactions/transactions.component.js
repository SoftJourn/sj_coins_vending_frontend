...
export var TransactionsComponent = (function () {
    function TransactionsComponent(transactionService, parser) {
    ...
    TransactionsComponent.prototype.ngOnInit = function () {
        ...
        var transaction = new Transaction(1, '', '', 1, '', 1, '', '');
    ...
    TransactionsComponent = __decorate([
        ...
        __metadata('design:paramtypes', [TransactionService, NgbDateParserFormatter])
